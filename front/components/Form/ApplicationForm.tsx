...
import Radio from '@/components/Form/parts/Radio'
import Text from '@/components/Form/parts/Text'
...
const ApplicationForm= () => {
  ...
  const validate = () => {
    ...
    if(customCtx.form.kana === "" || !/^[ァ-ヶー　]*$/.test(customCtx.form.kana)){
      alert("フリガナを全角カナで入力してください")
      return
    }
